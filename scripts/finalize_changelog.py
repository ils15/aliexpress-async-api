...
def main() -> None:
    ...
    # Replace the single [Unreleased] heading with:
    #   ## [Unreleased]          ← kept empty for next cycle
    #
    #   ---
    #
    #   ## [X.Y.Z] - YYYY-MM-DD  ← new versioned section
    #
    # Any content that was under [Unreleased] naturally falls under the
    # new versioned heading because it sits between the two headings.
